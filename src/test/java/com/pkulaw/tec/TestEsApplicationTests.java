...
import com.pkulaw.tec.entity.po.nested.article.AuthorUnitInfoJob;
...
class TestEsApplicationTests {
    ...
    void saveArticle() {
        ...
        AuthorUnitInfoJob unit1 = new AuthorUnitInfoJob();
        ...
        AuthorUnitInfoJob unit2 = new AuthorUnitInfoJob();
        unit2.setAuthorUnitId("001001");
        AuthorUnitInfoJob unit21 = new AuthorUnitInfoJob();
        ...
        AuthorUnitInfoJob unit3 = new AuthorUnitInfoJob();
        ...
        AuthorUnitInfoJob unit4 = new AuthorUnitInfoJob();
